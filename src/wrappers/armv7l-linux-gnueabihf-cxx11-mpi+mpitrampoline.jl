# Autogenerated wrapper script for Conduit_jll for armv7l-linux-gnueabihf-cxx11-mpi+mpitrampoline
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, HDF5_jll, Silo_jll, Zlib_jll, zfp_jll, MPItrampoline_jll, MPIPreferences)
