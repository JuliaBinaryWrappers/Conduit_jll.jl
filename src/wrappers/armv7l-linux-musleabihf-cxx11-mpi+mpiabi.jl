# Autogenerated wrapper script for Conduit_jll for armv7l-linux-musleabihf-cxx11-mpi+mpiabi
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, HDF5_jll, Silo_jll, Zlib_jll, zfp_jll, MPIABI_jll, MPIPreferences)
