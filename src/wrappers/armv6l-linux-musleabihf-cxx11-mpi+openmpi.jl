# Autogenerated wrapper script for Conduit_jll for armv6l-linux-musleabihf-cxx11-mpi+openmpi
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, HDF5_jll, Silo_jll, Zlib_jll, zfp_jll, OpenMPI_jll, MPIPreferences)
